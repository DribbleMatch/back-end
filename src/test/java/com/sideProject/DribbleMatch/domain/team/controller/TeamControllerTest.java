...
import com.sideProject.DribbleMatch.domain.team.controller.TeamController;
...
//                    "\"leaderId\": 2}";
    ...
    public class findAllTeamsTest {
        ...
        public void findAllTeams() throws Exception {
            ...
            // when, then
            mockMvc.perform(MockMvcRequestBuilders.get("/api/team?page={pageNum}&size={pageSize}", pageable.getPageNumber(), pageable.getPageSize()))
                    .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public class findTeamTest {
        ...
        public void findTeam() throws Exception {
            ...
            mockMvc.perform(MockMvcRequestBuilders.get("/api/team/{teamId}", teamId))
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$.data.region").value("서울시 영등포구"));
        }
    }
}
