...
public class PersonalMatchJoinRepositoryTestTest {
    ...
    public PersonalMatching initPersonalMatching(Region region) {
    ...
    public class BuilderTest {
        ...
        public void createPersonalMatchJoin() {
            ...
            PersonalMatching personalMatching = initPersonalMatching(region);
            ...
            assertThat(personalMatchJoin.getPersonalMatching()).isEqualTo(personalMatching);
        }
    }
}
